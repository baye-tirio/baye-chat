...
export default function SignUpPage() {
  ...
  const { logInLoading, logIn, continueGoogle, googleLoading } = useAuthStore();
  ...
  //sending the data to the sign-up endpoint
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center items-center p-6 sm:p-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  className={"input input-bordered w-full pl-10"}
                  placeholder="bayemanga16@gmail.com"
            ...
            {/* end of the continue with instagram button */}
          </form>
      ...
      {/* what stays on the right hand side */}
      <AuthImagePattern
        title="Welcome Back"
